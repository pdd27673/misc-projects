...
A collection of random ideas and projects — things that don't warrant their own repo but are too interesting to throw away.

This is a **branch-based repo**. Each branch is a self-contained project, deployed independently. Main stays clean.
